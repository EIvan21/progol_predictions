    ...
    try:
        ...
        def get_team_stats(team_id):
            ...
            for g in reversed(games):
                ...
                gf = g['goals']['home'] if is_h else g['goals']['away']
                ga = g['goals']['away'] if is_h else g['goals']['home']
                gd = gf - ga
        ...
        h_gf, h_ga, h_gd, h_pts = get_team_stats(h_id)
        a_gf, a_ga, a_gd, a_pts = get_team_stats(a_id)
